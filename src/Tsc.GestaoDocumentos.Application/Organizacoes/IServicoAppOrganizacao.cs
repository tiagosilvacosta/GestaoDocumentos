...
/// </summary>
public interface IServicoAppOrganizacao
{
    /// <summary>
    ...
    Task<OrganizacaoDto?> ObterPorIdAsync(IdOrganizacao id, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Token de cancelamento</param>
    /// <returns>Dados do tenant ou null se não encontrado</returns>
    Task<OrganizacaoDto?> ObterPorSlugAsync(string slug, CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<OrganizacaoDto>> ObterTodosAsync(PagedRequest request, CancellationToken cancellationToken = default);
    ...
    Task<OrganizacaoDto> CriarAsync(CreateTenantDto createTenant, CancellationToken cancellationToken = default);
    ...
    Task<OrganizacaoDto> AtualizarAsync(IdOrganizacao id, UpdateTenantDto updateTenant, CancellationToken cancellationToken = default);
